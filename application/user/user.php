...
//        ";
        $body = '<label>'.  $itemPostData['name_prifix'] . $itemPostData['name_suffix'] .'様</label><br><br>'
        ...
        . ' <label>-----------------------------------------------------------------------------------------------------</label>';
//        
//                            $body = "".$itemPostData['name_prifix']."".$itemPostData['name_suffix']."様
//
//ヘパリーゼキャンプグッズプレゼントキャンペーン事務局です。
//
//会員情報の変更を受け付けました。
//
//※このメールに心当たりがございませんでしたら、お手数をおかけしますが、下記事務局までお問い合わせください。
...
//お問い合わせを承っております。
//----------------------------------------------------------------------------------------------------- ";
    	$mailer->sendOne($_SESSION['mail'],$body,'会員情報の変更を受け付けました。','user.php');
