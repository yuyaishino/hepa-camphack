...
//        ";
        $body = '<label>'.  $row['name_prifix'] . $row['name_suffix'] .'様</label><br><br>'
...
//                    $body = "".$row['name_prifix']."".$row['name_suffix']."様
//
...
//----------------------------------------------------------------------------------------------------- ";
    	...
    	$mailer->sendOne($_SESSION['mail'],$body,'パスワード変更を受け付けました。','password.php');
