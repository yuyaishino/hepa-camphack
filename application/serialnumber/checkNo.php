...
//                $body = "".$_SESSION['name_prifix']."".$_SESSION['name_suffix']."様
//
//ヘパリーゼキャンプグッズプレゼントキャンペーン事務局です。
//
//シリアル№入力にて3回エラーとなりました。
//認証コードの入力が必要となります。下記の認証コードを画面より入力ください。
//".$_SESSION['v_code']."
//
...
//お問い合わせを承っております。
//----------------------------------------------------------------------------------------------------- ";
    $status = $mailer->sendOne( $_SESSION['mail'] , $body, '本人確認用の認証コードです','checkNo.php');
