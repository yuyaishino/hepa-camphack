            ...
            <div class="content" id="formBlock">
                <section>
                    ...
                    <dl class="user-input">
                        ...
                        <dt>パスワード</dt>
                        <dd><input id="password" name="password" type="password" class="add" maxlength="20" placeholder="半角英数字6～20桁"
                                   value="<?= array_key_exists('temp_password', $_SESSION) ? $_SESSION['temp_password'] : '' ?>">
                        </dd>
                        <dt>パスワード（確認用）</dt>
                        <dd><input id="re-password" type="password" class="add" maxlength="20" placeholder="半角英数字6～20桁"
                                   value="<?= array_key_exists('temp_password', $_SESSION) ? $_SESSION['temp_password'] : '' ?>">
                        </dd>
                        <dt>氏名</dt>
