      ...
      <dl class="user-input">
        ...
        <dd>
            <select name="year" id="year"> <option value="">-</option>
                ...
                <option value="1982">1982</option> <option value="1983">1983</option> <option value="1984">1984</option> <option value="1985">1985</option> <option value="1986">1986</option> <option value="1987">1987</option> <option value="1988">1988</option> <option value="1989">1989</option> <option value="1990">1990</option> <option value="1991">1991</option> <option value="1992">1992</option> <option value="1993">1993</option> <option value="1994">1994</option> <option value="1995">1995</option> <option value="1996">1996</option> <option value="1997">1997</option> <option value="1998">1998</option> <option value="1999">1999</option> <option value="2000">2000</option> <option value="2001">2001</option> <option value="2002">2002</option> <option value="2003">2003</option> <option value="2004">2004</option> <option value="2005">2005</option> <option value="2006">2006</option> <option value="2007">2007</option> <option value="2008">2008</option> <option value="2009">2009</option> <option value="2010">2010</option> <option value="2011">2011</option> <option value="2012">2012</option> <option value="2013">2013</option> <option value="2014">2014</option> <option value="2015">2015</option> <option value="2016">2016</option> <option value="2017">2017</option> <option value="2018">2018</option> <option value="2019">2019</option> <option value="2020">2020</option> <option value="2021">2021</option>  </select> 年　
          <select name="month" id="month"> <option value="">-</option> <option value="1" selected>1</option> <option value="2">2</option> <option value="3">3</option> <option value="4">4</option> <option value="5">5</option> <option value="6">6</option> <option value="7">7</option> <option value="8">8</option> <option value="9">9</option> <option value="10">10</option> <option value="11">11</option> <option value="12">12</option> </select> 月　
...
<!--        <dt style="width: 5em;float: left;">郵便番号</dt>
        ...
        <dt>住所1</dt>
        <dd><input type="text" class="add" name="address1" maxlength="40" placeholder="(入力例:東京都中央区日本橋小舟町)"></dd>
<!--        <dd style="margin-bottom: 0px;padding: 0px 0 5px 0em;">(入力例:東京都中央区日本橋小舟町)</dd>
        <dd><input type="text" class="add" name="address1" maxlength="40"></dd>-->
        
        <dt>住所2</dt>
        <dd><input type="text" class="add" name="address2" maxlength="40" placeholder="(入力例:10-11)"></dd>
<!--        <dd style="margin-bottom: 0px;padding: 0px 0 5px 0em;">(入力例:10-11)</dd>
        <dd><input type="text" class="add" name="address2" maxlength="40" ></dd>-->
        <dt>住所3</dt>
        <dd><input type="text" class="add" name="address3" maxlength="40" placeholder="(入力例:ゼリアマンション101)"></dd>
